    ...
    <section className="grid md:grid-cols-2 grid-cols-1 padding-x  mt-10">
      <div className=" flex flex-col gap-4">
        <div className="flex items-center gap-2">
          <h2 className="font-extrabold text-lg text-primary-blue">Telefone:</h2> <h4 className=" font-semibold text-black-100 dark:text-primary-blue-100 ">47 9997 9998</h4>
        </div>
        <div className="flex items-center gap-2">
          <h2 className="font-extrabold text-lg text-primary-blue">Email:</h2>{" "}
